...
from app.services.narrative_provider import DeterministicNarrativeProvider, GeminiNarrativeProvider, NarrativePrompt, NarrativeProvider
...
def _build_provider() -> NarrativeProvider:
    ...
    logger.info("narrative_provider=deterministic (no GEMINI_API_KEY set)")
